    ...
    <section id="contato" className="py-24">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          className="flex flex-col gap-6 max-w-md mx-auto items-center"
        >
          {[
            {
            ...
            },
            {
              ...
              label: "WhatsApp",
              valor: "(63) 99113-0560",
              href: "https://wa.me/5563991130560",
            },
          ].map((c) => (
            <a key={c.label} href={c.href} target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-4 p-4 rounded-xl transition-all duration-200 hover:scale-[1.01] w-full"
          ...
          <div className="w-full text-center">
            ...
            <div className="flex gap-3 justify-center">
              {[
                ...
                {
                  label: "LinkedIn",
                  href: "https://www.linkedin.com/in/ingrid-gomes-pereira-b6878633b/",
